...
Selamat datang di portal dokumentasi teknis **Instant Gratification: Stew Stacker Addon** untuk **Minecraft 26.2** (menargetkan `MC 26.1.2 / 26.2`). Seluruh dokumentasi mencerminkan pemetaan bytecode, dependensi Loom, dan spesifikasi fitur yang tepat untuk rilis ini.
...
| :--- | :--- | :--- |
| **Penumpukan Rebusan & Ergonomi Konsumsi** | Mekanika penumpukan rebusan, logika pengembalian mangkuk, kompresi penyimpanan | [[26.2 Penumpukan Rebusan & Ergonomi Konsumsi|id_id-26.2-Stew-Stacking-and-Consumption-Ergonomics]] |
