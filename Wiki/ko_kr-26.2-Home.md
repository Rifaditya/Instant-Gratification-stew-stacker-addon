...
**Minecraft 26.2**(`MC 26.1.2 / 26.2` 타깃)용 **Instant Gratification: Stew Stacker Addon** 공식 기술 문서 포털에 오신 것을 환영합니다. 이 버전 트리의 모든 문서는 해당 릴리스의 바이트코드 매핑, Loom 종속성 및 기능 사양을 반영합니다.
...
| :--- | :--- | :--- |
| **스튜 스태킹 및 섭취 인체공학** | 스튜 스태킹 메커니즘, 빈 그릇 반환 로직, 보관함 압축 계산 | [[26.2 스튜 스태킹 및 섭취 인체공학|ko_kr-26.2-Stew-Stacking-and-Consumption-Ergonomics]] |
