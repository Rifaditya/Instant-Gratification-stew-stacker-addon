...
欢迎查阅 **Instant Gratification: Potion Stacker Addon（即时满足：炖菜堆叠扩展）** 面向 **Minecraft 26.3**（针对 `MC 26.3-snapshot-6 / 26.3`）的专用技术文档门户。该版本树内的所有文档均严格反映针对该快照版本的字节码映射、Loom 依赖项和功能规范。
...
| 功能特性 / 子系统 | 说明 | 专用维基页面 |
| :--- | :--- | :--- |
| **炖菜堆叠与食用人体工学** | 炖菜堆叠机制、空碗返还逻辑、容器存储压缩数学 | [[26.3 炖菜堆叠与食用人体工学|zh_cn-26.3-Stew-Stacking-and-Consumption-Ergonomics]] |
