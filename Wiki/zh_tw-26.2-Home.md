...
歡迎查閱 **Instant Gratification: Stew Stacker Addon（即時滿足：燉菜堆疊擴充）** 面向 **Minecraft 26.2**（針對 `MC 26.1.2 / 26.2`）的專用技術文件門戶。該版本樹內的所有文件均嚴格反映針對該發布版本的位元組碼對映、Loom 相依性與功能規範。
...
| 功能特性 / 子系統 | 說明 | 專用維基頁面 |
| :--- | :--- | :--- |
| **燉菜堆疊與食用人體工學** | 燉菜堆疊機制、空碗返還邏輯、容器儲存壓縮數學 | [[26.2 燉菜堆疊與食用人體工學|zh_tw-26.2-Stew-Stacking-and-Consumption-Ergonomics]] |
