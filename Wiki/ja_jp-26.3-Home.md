...
**Instant Gratification: Stew Stacker Addon** の **Minecraft 26.3**（対象：`MC 26.3-snapshot-6 / 26.3`）向け技術ドキュメントポータルへようこそ。このツリー内のすべてのドキュメントは、このスナップショット向けの正確なバイトコードマッピング、Loom 依存関係、および仕様を反映しています。
...
| :--- | :--- | :--- |
| **シチューのスタックと消費人間工学** | シチュースタック仕様、空のボウル返還ロジック、インベントリ圧縮計算 | [[26.3 シチューのスタックと消費人間工学|ja_jp-26.3-Stew-Stacking-and-Consumption-Ergonomics]] |
